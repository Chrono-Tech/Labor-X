    ...
    return (
      <div className={styles.root}>
        ...
        <div className={styles.content}>
          ...
          <WhiteRoundedButton component={Link} to='/introduction/crypto-currencies'>​NEXT: Crypto-currencies</WhiteRoundedButton>
          <Button component={Link} to='/auth/signup/account-password' className={styles.newAccountButton}>New Account</Button>
          <MobileStepper
            variant="dots"
            steps={5}
            position="static"
