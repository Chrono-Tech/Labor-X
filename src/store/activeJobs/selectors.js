...
export const getToPayCards = createSelector(getCards, (cards) => cards.filter((x) => x.state === JOB_STATE_PENDING_FINISH))
export const getOtherCards = createSelector(getCards, (cards) => cards.filter((x) => x.state !== JOB_STATE_PENDING_FINISH))